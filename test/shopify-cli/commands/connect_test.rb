  ...
  module Commands
    class ConnectTest < MiniTest::Test
      ...
      def test_connect_asks_project_type_and_writes_yml_when_no_project_exists
        ...
        CLI::UI::Prompt.expects(:ask).with("What type of project would you like to connect?").returns('node')
        CLI::UI::Prompt.expects(:ask).with('To which organization does this project belong?').returns(101)
      ...
      def test_connect_doesnt_write_yml_when_current_project_exists
        ...
        CLI::UI::Prompt.expects(:ask).with("What type of project would you like to connect?").never
        Resources::EnvFile.any_instance.expects(:write)
